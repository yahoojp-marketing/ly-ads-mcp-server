...
class RecommendationServiceType(str, Enum):
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of RecommendationServiceType from a JSON string"""
