...
class AudienceListServiceContainUnavailableAdActionUserListFlg(str, Enum):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AudienceListServiceContainUnavailableAdActionUserListFlg from a JSON string"""
