...
class AccountCustomizerServiceApprovalStatus(str, Enum):
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AccountCustomizerServiceApprovalStatus from a JSON string"""
