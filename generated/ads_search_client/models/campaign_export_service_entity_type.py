...
class CampaignExportServiceEntityType(str, Enum):
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CampaignExportServiceEntityType from a JSON string"""
